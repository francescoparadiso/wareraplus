...
const MB_DICT = {
  en: { views: 'Views', insights: 'Insights', settings: 'Settings', battles: 'Battles', timeMachine: 'Time machine', diplomacy: 'Diplomacy', alliances: 'Alliances', sphere: 'Sphere', damage: 'Weekly Dmg', population: 'Population', contested: 'Contested', warIntensity: 'War history', playstyle: 'War vs Trade', politics: 'Politics', allianceStats: 'Alliance stats', ecoOptimizer: 'Industrial Optimizer', news: 'News', searchPh: 'Search nation or alliance…', groupNations: 'Nations', groupAlliances: 'Alliances', noResults: 'No results', favorites: 'Favorites', back: 'Back', muExplorer: 'Military Units', nationStats: 'Nation stats', howTo: 'How to use', groupMus: 'Military units', noFavorites: 'No pinned items yet' },
  it: { views: 'Viste mappa', insights: 'Approfondimenti', settings: 'Impostazioni', battles: 'Battaglie', timeMachine: 'Time machine', diplomacy: 'Diplomazia', alliances: 'Alleanze', sphere: 'Sfera', damage: 'Danni Sett.', population: 'Popolazione', contested: 'Regioni contese', warIntensity: 'Storico bellico', playstyle: 'Guerra vs Commercio', politics: 'Politica', allianceStats: 'Statistiche alleanze', ecoOptimizer: 'Ottimizzatore industriale', news: 'News', searchPh: 'Cerca nazione o alleanza…', groupNations: 'Nazioni', groupAlliances: 'Alleanze', noResults: 'Nessun risultato', favorites: 'Preferiti', back: 'Indietro', muExplorer: 'Unità Militari', nationStats: 'Statistiche nazioni', howTo: 'Come si usa', groupMus: 'Unità militari', noFavorites: 'Nessun elemento salvato' },
  es: { views: 'Vistas', insights: 'Análisis', settings: 'Ajustes', battles: 'Batallas', timeMachine: 'Time machine', diplomacy: 'Diplomacia', alliances: 'Alianzas', sphere: 'Esfera', damage: 'Daño Sem.', population: 'Población', contested: 'Regiones disputadas', warIntensity: 'Histórico bélico', playstyle: 'Guerra vs Comercio', politics: 'Política', allianceStats: 'Estadísticas de alianzas', ecoOptimizer: 'Optimizador industrial', news: 'News', searchPh: 'Buscar nación o alianza…', groupNations: 'Naciones', groupAlliances: 'Alianzas', noResults: 'Sin resultados', favorites: 'Favoritos', back: 'Atrás', muExplorer: 'Unidades Militares', nationStats: 'Estadísticas de naciones', howTo: 'Cómo se usa', groupMus: 'Unidades militares', noFavorites: 'Aún no hay elementos guardados' },
  de: { views: 'Ansichten', insights: 'Einblicke', settings: 'Einstellungen', battles: 'Schlachten', timeMachine: 'Zeitmaschine', diplomacy: 'Diplomatie', alliances: 'Bündnisse', sphere: 'Sphäre', damage: 'Wöch. Schaden', population: 'Bevölkerung', contested: 'Umkämpfte Regionen', warIntensity: 'Kriegsgeschichte', playstyle: 'Krieg vs Handel', politics: 'Politik', allianceStats: 'Bündnisstatistiken', ecoOptimizer: 'Industrie-Optimierer', news: 'News', searchPh: 'Nation oder Bündnis suchen…', groupNations: 'Nationen', groupAlliances: 'Bündnisse', noResults: 'Keine Ergebnisse', favorites: 'Favoriten', back: 'Zurück', muExplorer: 'Militäreinheiten', nationStats: 'Nationsstatistiken', howTo: 'Anleitung', groupMus: 'Militäreinheiten', noFavorites: 'Noch nichts angeheftet' },
  fr: { views: 'Vues', insights: 'Analyses', settings: 'Paramètres', battles: 'Batailles', timeMachine: 'Time machine', diplomacy: 'Diplomatie', alliances: 'Alliances', sphere: 'Sphère', damage: 'Dégâts Hebdo.', population: 'Population', contested: 'Régions disputées', warIntensity: 'Historique de guerre', playstyle: 'Guerre vs Commerce', politics: 'Politique', allianceStats: 'Stats des alliances', ecoOptimizer: 'Optimiseur industriel', news: 'News', searchPh: 'Rechercher nation ou alliance…', groupNations: 'Nations', groupAlliances: 'Alliances', noResults: 'Aucun résultat', favorites: 'Favoris', back: 'Retour', muExplorer: 'Unités Militaires', nationStats: 'Statistiques des nations', howTo: "Mode d'emploi", groupMus: 'Unités militaires', noFavorites: 'Aucun élément épinglé' },
  nl: { views: 'Weergaven', insights: 'Inzichten', settings: 'Instellingen', battles: 'Veldslagen', timeMachine: 'Tijdmachine', diplomacy: 'Diplomatie', alliances: 'Bondgenootschappen', sphere: 'Invloedssfeer', damage: 'Wekel. Schade', population: 'Bevolking', contested: 'Betwiste regio’s', warIntensity: 'Oorlogsgeschiedenis', playstyle: 'Oorlog vs Handel', politics: 'Politiek', allianceStats: 'Alliantiestatistieken', ecoOptimizer: 'Industriële optimizer', news: 'News', searchPh: 'Zoek natie of alliantie…', groupNations: 'Naties', groupAlliances: 'Bondgenootschappen', noResults: 'Geen resultaten', favorites: 'Favorieten', back: 'Terug', muExplorer: 'Militaire Eenheden', nationStats: 'Natiestatistieken', howTo: 'Uitleg', groupMus: 'Militaire eenheden', noFavorites: 'Nog niets vastgezet' },
  sv: { views: 'Vyer', insights: 'Insikter', settings: 'Inställningar', battles: 'Strider', timeMachine: 'Tidsmaskin', diplomacy: 'Diplomati', alliances: 'Allianser', sphere: 'Sfär', damage: 'Veckoskada', population: 'Befolkning', contested: 'Omstridda regioner', warIntensity: 'Krigshistorik', playstyle: 'Krig vs Handel', politics: 'Politik', allianceStats: 'Alliansstatistik', ecoOptimizer: 'Industrioptimerare', news: 'News', searchPh: 'Sök nation eller allians…', groupNations: 'Nationer', groupAlliances: 'Allianser', noResults: 'Inga resultat', favorites: 'Favoriter', back: 'Tillbaka', muExplorer: 'Militära Enheter', nationStats: 'Nationsstatistik', howTo: 'Så funkar det', groupMus: 'Militära enheter', noFavorites: 'Inget fäst ännu' },
  pt: { views: 'Vistas', insights: 'Análises', settings: 'Definições', battles: 'Batalhas', timeMachine: 'Máquina do tempo', diplomacy: 'Diplomacia', alliances: 'Alianças', sphere: 'Esfera', damage: 'Dano Sem.', population: 'População', contested: 'Regiões disputadas', warIntensity: 'Histórico bélico', playstyle: 'Guerra vs Comércio', politics: 'Política', allianceStats: 'Estatísticas de alianças', ecoOptimizer: 'Otimizador industrial', news: 'News', searchPh: 'Procurar nação ou aliança…', groupNations: 'Nações', groupAlliances: 'Alianças', noResults: 'Sem resultados', favorites: 'Favoritos', back: 'Voltar', muExplorer: 'Unidades Militares', nationStats: 'Estatísticas das nações', howTo: 'Como usar', groupMus: 'Unidades militares', noFavorites: 'Nada fixado ainda' },
  ar: { views: 'العروض', insights: 'رؤى', settings: 'الإعدادات', battles: 'المعارك', timeMachine: 'آلة الزمن', diplomacy: 'الدبلوماسية', alliances: 'التحالفات', sphere: 'النطاق', damage: 'الضرر الأسبوعي', population: 'السكان', contested: 'المناطق المتنازع عليها', warIntensity: 'تاريخ الحرب', playstyle: 'حرب مقابل تجارة', politics: 'السياسة', allianceStats: 'إحصاءات التحالفات', ecoOptimizer: 'مُحسِّن صناعي', news: 'الأخبار', searchPh: 'ابحث عن دولة أو تحالف…', groupNations: 'الدول', groupAlliances: 'التحالفات', noResults: 'لا نتائج', favorites: 'المفضلة', back: 'رجوع', muExplorer: 'الوحدات العسكرية', nationStats: 'إحصاءات الدول', howTo: 'كيفية الاستخدام', groupMus: 'الوحدات العسكرية', noFavorites: 'لا عناصر مثبتة بعد' },
};
function mbT(key) {
...
function setupSubviewWatch() {
  ...
  const update = () => document.body.classList.toggle('wp-subview-open', isPoliticalOpen() || isEcoViewOpen() || isMuViewOpen() || isNewsViewOpen() || isNationsViewOpen() || isGuideViewOpen() || isStatsOpen());
