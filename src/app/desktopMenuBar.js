...
const MB_DICT = {
  ...
  pt: { views: 'Vistas', insights: 'Análises', settings: 'Definições', battles: 'Batalhas', timeMachine: 'Máquina do tempo', diplomacy: 'Diplomacia', alliances: 'Alianças', sphere: 'Esfera', damage: 'Dano Sem.', population: 'População', production: 'Produção', contested: 'Regiões disputadas', warIntensity: 'Histórico bélico', playstyle: 'Guerra vs Eco', politics: 'Política', allianceStats: 'Estatísticas de alianças', ecoOptimizer: 'Otimizador industrial', market: 'Rendimentos de produção', news: 'News', searchPh: 'Procurar nação ou aliança…', groupNations: 'Nações', groupAlliances: 'Alianças', noResults: 'Sem resultados', favorites: 'Favoritos', back: 'Voltar', muExplorer: 'Unidades Militares', nationStats: 'Estatísticas das nações', howTo: 'Como usar', groupMus: 'Unidades militares', noFavorites: 'Nada fixado ainda' },
...
function setupSubviewWatch() {
  ...
  const update = () => document.body.classList.toggle('wp-subview-open', isPoliticalOpen() || isEcoViewOpen() || isMarketViewOpen() || isMuViewOpen() || isNewsViewOpen() || isNationsViewOpen() || isGuideViewOpen() || isStatsOpen());
