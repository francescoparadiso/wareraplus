...
const MB_DICT = {
  ...
  de: { views: 'Ansichten', insights: 'Einblicke', settings: 'Einstellungen', battles: 'Schlachten', timeMachine: 'Zeitmaschine', diplomacy: 'Diplomatie', alliances: 'Bündnisse', sphere: 'Sphäre', damage: 'Wöch. Schaden', population: 'Bevölkerung', production: 'Produktion', contested: 'Umkämpfte Regionen', warIntensity: 'Kriegsgeschichte', playstyle: 'Krieg vs Eco', politics: 'Politik', allianceStats: 'Bündnisstatistiken', ecoOptimizer: 'Industrie-Optimierer', market: 'Produktionserträge', battleArchive: 'Schlachtenarchiv', news: 'News', searchPh: 'Nation oder Bündnis suchen…', groupNations: 'Nationen', groupAlliances: 'Bündnisse', noResults: 'Keine Ergebnisse', favorites: 'Favoriten', back: 'Zurück', muExplorer: 'Militäreinheiten', nationStats: 'Nationsstatistiken', howTo: 'Anleitung', privateArea: 'Geschützter Bereich', groupMus: 'Militäreinheiten', noFavorites: 'Noch nichts angeheftet', menu: 'Menü', search: 'Suchen' },
